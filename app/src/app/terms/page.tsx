	...
	return (
		<div className="mx-auto p-6 overflow-y-auto h-screen">
			...
			<ul>
				...
				<li>
					Do not use automated bots or scripts to interact with the
			...
			<p>
				...
				explains how we collect and use your personal data. By using the
				Service, you agree to our privacy practices.
			</p>
